			              ...
			              <div class="card border-left-primary shadow h-100 py-2">
			                <div class="card-body">
			                  <div class="row no-gutters align-items-center">
			                    ...
			                    <div class="col-auto">
								<a class="nav-link" href="<?= base_url('barang') ?>"><i class="fas fa-box fa-2x text-gray-300"></i></a>
			                    </div>
			                  </div>
			                </div>
			              </div>
			              ...
			              <div class="card border-left-success shadow h-100 py-2">
			                <div class="card-body">
			                  <div class="row no-gutters align-items-center">
			                    ...
			                    <div class="col-auto">
								<a class="nav-link" href="<?= base_url('petugas') ?>"><i class="fas fa-users fa-2x text-gray-300"></i></a>
			                    </div>
			                  </div>
			                </div>
			              </div>
			              ...
			              <div class="card border-left-info shadow h-100 py-2">
			                <div class="card-body">
			                  <div class="row no-gutters align-items-center">
			                    ...
			                    <div class="col-auto">
								<a class="nav-link" href="<?= base_url('pengeluaran') ?>"><i class="fas fa-file-invoice fa-2x text-gray-300"></i></a>
			                    </div>
			                  </div>
			                </div>
			              </div>
			              ...
			              <div class="card border-left-warning shadow h-100 py-2">
			                <div class="card-body">
			                  <div class="row no-gutters align-items-center">
			                    ...
			                    <div class="col-auto">
								<a class="nav-link" href="<?= base_url('penerimaan') ?>"><i class="fas fa-users fa-2x text-gray-300"></i></a>
			                    </div>
			                  </div>
			                </div>
			              </div>
			          	...
			          	<div class="col-md-6">
							<div class="card shadow">
								...
								<div class="card-body">
									...
									<input  type="text" value="<?= $web->nama_web ?>" readonly class="form-control mt-2 mb-2">
									<strong>Nama Pemilik : </strong><br>
									<input  type="text" value="<?= $web->nama_pemilik ?>" readonly class="form-control mt-2 mb-2">
									<strong>No Telepon : </strong><br>
									<input  type="text" value="<?= $web->no_telepon ?>" readonly class="form-control mt-2 mb-2">
									<strong>Alamat : </strong><br>
									<input  type="text" value="<?= $web->alamat ?>" readonly class="form-control mt-2">
								</div>				
							</div>
			          	</div>
			          	<div class="col-md-6">
